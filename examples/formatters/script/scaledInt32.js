...
/*------------------------------------------------------------------------------
 *    An integer 32 bit data formatting script using  the specified 
 *    formatting template
 * -----------------------------------------------------------------------------
 *  Attributes:
 * -------------------------------------
 *  id      - formatter id string (for debug)
 *  file    - java script file name (for debug)
 *  min     - minimum value
 *  max     - maximum value
 *  format  - string of format template "iii.fff" 
