...
public:
    CDataReqBase* mpReq;
    explicit CQEventDataRequest(CDataReqBase* _req):
...
private:
  CDataReqBase(){};
public:
  explicit CDataReqBase(QWaitCondition* _waitCond) :
    mpWaitCond(_waitCond),
    mpModbusReply(nullptr){}
...
protected:
  ...
  virtual LQModbusMasterBase::SReply::EStatus
    handleReply(QModbusReply* _reply) = 0;
};
...
public:
  ...
  {
    return _client->sendReadRequest(
        QModbusDataUnit( mRegType, mStartAddr, mRegQuant), mDevId);
  }

  virtual LQModbusMasterBase::SReply::EStatus
    handleReply(QModbusReply* _reply) final
  {
...
public:
  ...
  {
    return _client->sendRawRequest(
        QModbusRequest(
          QModbusRequest::FunctionCode::WriteSingleRegister, mAddr, mReg),
        mDevId);
  }
  ...
  virtual LQModbusMasterBase::SReply::EStatus
    handleReply(QModbusReply* _reply) final
  {
    if(_reply->rawResult().functionCode() !=
        QModbusResponse::FunctionCode::WriteSingleRegister)
    {
      return  MTMaster::SReply::EStatus::WRONG_RESP;
    }
    return MTMaster::SReply::EStatus::OK;
...
public:
  ...
  explicit CDataRequestWriteMultipleRegs(
      quint8 _devId,
      quint16 _startAddr,
      quint16 _regQuant,
      const quint16* _regs,
      QWaitCondition* _waitCond) :
    CDataReqBase(_waitCond),
    mDevId(_devId),
    mStartAddr(_startAddr),
    mRegQuant(_regQuant),
    mDataUnit(
        QModbusDataUnit::RegisterType::HoldingRegisters, _startAddr, _regQuant)
  {
...
public:
  ...
  {
    return _client->sendReadRequest(
        QModbusDataUnit(mRegType, mStartAddr, mBitsQuant), mDevId);
  }
...
public:
  ...
  virtual QModbusReply* sendRequest(QModbusClient* _client) final
  {
    ...
    return _client->sendRawRequest(
        QModbusRequest(
          QModbusRequest::FunctionCode::WriteSingleCoil, mAddr, data),
        mDevId);
  }
  ...
  {
    if(_reply->rawResult().functionCode() !=
        QModbusResponse::FunctionCode::WriteSingleCoil)
    {
      return MTMaster::SReply::EStatus::WRONG_RESP;
    }
    else
...
//==============================================================================LCModbusMasterBase
LQModbusMasterBase::LQModbusMasterBase(QObject* _parent) : 
  QObject(_parent), 
  mpTimer(nullptr)
{
}
...
//------------------------------------------------------------------------------
LQModbusMasterBase::SReply LQModbusMasterBase:: readInputRegisters(
    quint8 _devId,quint16 _addr, quint16 _regQuant, quint16 _regs[])
{
  ...
  CDataRequestReadRegs req(
      _devId, _addr, _regQuant, _regs, CDataRequestReadRegs::INPUT, &mWaitCond);
...
LQModbusMasterBase::readHoldingRegisters(
    quint8 _devId, quint16 _addr, quint16 _regQuant, quint16 _regs[])
{
  if((_regQuant > MODBUS_MAX_READ_REGISTER_COUNT)||
      (_regQuant == 0)||(_regs == nullptr))
  ...
  CDataRequestReadRegs req(
      _devId, 
      _addr, _regQuant, _regs, CDataRequestReadRegs::HOLDING, &mWaitCond);
  mMutexThread.lock();
  mMutexEvent.lock();
...
//------------------------------------------------------------------------------
  LQModbusMasterBase::SReply
LQModbusMasterBase::writeSingleRegister(
    quint8 _devId, quint16 _addr, quint16 _reg)
{
    ...
    quint16 _regQuant, const quint16 _regs[])
{
  ...
  CDataRequestWriteMultipleRegs req(
      _devId, _addr, _regQuant, _regs, &mWaitCond);
...
//------------------------------------------------------------------------------
LQModbusMasterBase::SReply LQModbusMasterBase::readCoils(
    quint8 _devId, quint16 _startAddr, quint16 _coilsQuant, quint8 _bits[])
{
...
//------------------------------------------------------------------------------
LQModbusMasterBase::SReply LQModbusMasterBase::writeSingleCoils(
    quint8 _devId, quint16 _addr, quint8 _bit)
{
...
//------------------------------------------------------------------------------
LQModbusMasterBase::SReply LQModbusMasterBase::writeMultipleCoils(
    quint8 _devId, quint16 _addr, quint16 _size, const quint8 _bits[])
{
...
//------------------------------------------------------------------------------
LQModbusMasterBase::SReply LQModbusMasterBase::readDiscreteInputs(
    quint8 _devId, quint16 _startAddr, quint16 _inputsQuant, quint8 _bits[])
{
