...
public:
  ...
  struct SReply
  {
    ...
    SReply(EStatus _status, quint8 _except_code) :
      status(_status),
      modbusExceptionCode(_except_code){}
  };
...
public:
  ...
  virtual SReply writeSingleRegister(
      quint8 _devId, quint16 _addr, quint16 _reg) final;

  virtual SReply writeMultipleRegisters(quint8 _devId,
      quint16 _addr, quint16 _regQuan, const quint16 _regs[]) final;

  virtual SReply readCoils(
      quint8 _devId,
      quint16 _startAddr, quint16 _coilsQuant, quint8 _bits[]) final;

  virtual SReply writeSingleCoils(
      quint8 _devId, quint16 _addr, quint8 _bit) final;

  virtual SReply writeMultipleCoils(
      quint8 _devId,
      quint16 _addr, quint16 _regQuan, const quint8 _bits[]) final;

  virtual SReply readDiscreteInputs(
      quint8 _devId,
      quint16 _startAddr, quint16 _inputsQuant, quint8 _bits[]) final;
