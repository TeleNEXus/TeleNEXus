...
/*   QString attr = _element.attribute(__slAttributes.fontid); */
...
/*   else */
/*   { */
/*     attr = _element.attribute(__slAttributes.font); */
/*     if(!attr.isNull()) */
/*     { */
/*       style += "font : " + attr + "; "; */
/*     } */
...
/*   attr = _element.attribute(__slAttributes.bgcolor); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("background: %1; ").arg(attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.bgimage); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("background-image:url(\"%1\"); " ).arg(_app.getProjectPath() + attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.bgpos); */
/*   if(!attr.isNull()) */
/*   { */
/*     if(!attr.isNull()) style += QString("background-position: %1 ;").arg(attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.textcolor); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("color: %1; ").arg(attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.minwidth); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("min-width: %1px; ").arg(attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.minheight); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("min-height: %1px; ").arg(attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.maxwidth); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("max-width: %1px; ").arg(attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.maxheight); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("max-height: %1px; ").arg(attr); */
/*   } */

/*   attr = _element.attribute(__slAttributes.fixwidth); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("max-width: %1px; ").arg(attr); */
/*     style += QString("min-width: %1px; ").arg(attr); */
...
/*   attr = _element.attribute(__slAttributes.fixheight); */
/*   if(!attr.isNull()) */
/*   { */
/*     style += QString("max-height: %1px; ").arg(attr); */
/*     style += QString("min-height: %1px; ").arg(attr); */
...
/*   attr = _element.attribute(__slAttributes.aligns.attrName); */
/*   if(!attr.isNull()) */
/*   { */
...
/* //============================================================================== */
/* const LCBuildersCommon::SAttributes __slAttributes; */
/* //------------------------------------------------------------------------------ */
/* LCBuildersCommon LCBuildersCommon::instance; */ 
...
/*         QWidget& _widget) */
/* { */
/*     QString attr_pos = _element.attribute(__slAttributes.posx); */
...
/*     attr_pos = _element.attribute(__slAttributes.posy); */
/*     flag = false; */
...
/*         QWidget& _widget) */
/* { */
/*     QString attr_width = _element.attribute(__slAttributes.fixwidth); */
/*     QString attr_height = _element.attribute(__slAttributes.fixheight); */
