...
quint8    LCDataStrFormatBase::msFillCharUndefDefLength(4);
QChar     LCDataStrFormatBase::msFillCharWrongDef('?');
quint8    LCDataStrFormatBase::msFillCharWrongDefLength(3);
...
void LCDataStrFormatBase::setFillCharUndefDef(QChar _c, quint8 _length)
{
...
void LCDataStrFormatBase::setFillCharWrongDef(QChar _c, quint8 _length)
{
